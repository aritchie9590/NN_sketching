...
# w_star_gnhs, loss_log_hsketch, val_err_hsketch, t_solve_hsketch = solver(data, model, lam, w0, loss_type,
#                                                                      ITER_GNHS, n_cg_iter,
...
plt.subplot(2,1,2)
plt.plot(np.arange(len(val_err_gn)), val_err_gn, 'k', np.arange(len(val_err_sketch)), val_err_sketch, 'g',
